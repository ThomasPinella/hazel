...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install hazel-ai[matrix]"
    ) from e
...
from hazel.config.paths import get_data_dir, get_media_dir
from hazel.config.schema import Base
from hazel.utils.helpers import safe_filename
