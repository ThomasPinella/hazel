...
from hazel.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from hazel.agent.tools.registry import ToolRegistry
from hazel.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("hazel.agent.tools.mcp.logger.warning", _warning)
